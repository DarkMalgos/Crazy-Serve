            ...
            if(RageBarScript.health == 0)
            {
                ...
                if(servingScript.drinkOnPlate.Count < 3){
                    ...
                    if(servingScript.drinkOnPlate.Count == 0){
                        BoissonBleue.transform.SetParent(this.plate.transform.GetChild(0).gameObject.transform);
                        BoissonBleue.transform.localPosition = new Vector2(0,0);
                    }else if(servingScript.drinkOnPlate.Count == 1){
                        BoissonBleue.transform.SetParent(this.plate.transform.GetChild(1).gameObject.transform);
                        BoissonBleue.transform.localPosition = new Vector2(0,0);
                    }else if(servingScript.drinkOnPlate.Count == 2){
                        BoissonBleue.transform.SetParent(this.plate.transform.GetChild(2).gameObject.transform);
                        BoissonBleue.transform.localPosition = new Vector2(0,0);
                    }
                    servingScript.drinkOnPlate.Add(BoissonBleue);
                }
            }
        }
    }
